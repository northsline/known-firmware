...
class SSD1306(framebuf.FrameBuffer):
    ...
    def init_display(self):
        for cmd in (
            ...
            SET_COM_PIN_CFG, 0x12 if self.width == 128 and self.height == 64 else 0x02,
            SET_CONTRAST, 0xCF, SET_PRECHARGE, 0xF1, SET_VCOM_DESEL, 0x40, SET_ENTIRE_ON,
            SET_NORM_INV, SET_DISP_CLK_DIV, 0x80, SET_CHARGE_PUMP, 0x14, SET_DISP | 0x01
        ): self.write_cmd(cmd)
        self.fill(0)
        self.show()
